...
train=pd.read_csv('./train_na.csv',index_col=0)
test=pd.read_csv('./test_na.csv',index_col=0)

lat_train_x=pd.read_csv('./lat_train_x.csv',index_col=0)
lat_test_x=pd.read_csv('./lat_test_x.csv',index_col=0)
lat_target=pd.read_csv('./lat_target.csv',index_col=0,header=None)

lon_train_x=pd.read_csv('./lon_train_x.csv',index_col=0)
lon_test_x=pd.read_csv('./lon_test_x.csv',index_col=0)
